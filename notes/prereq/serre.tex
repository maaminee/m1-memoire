...
Supposons d'abord que $E$ et $E'$ soient deux formes indéfinies de type I ayant même rang $n$ et même indice $\tau$. Si $n < 5$, le résultat découle d'une vérification directe sur les petites dimensions que nous décidons d'omettre par soucis de simplification. Supposons donc $n \geq 5$.
...
\begin{itemize}
    ...
    \item Si $y \cdot y$ est un entier pair, la construction précédente échoue. C'est ici que l'hypothèse de type I intervient : par définition, il existe au moins un vecteur $w \in E$ dont la norme $w \cdot w$ est un entier impair. Posons $m = x \cdot w \in \mathbb{Z}$. Définissons un nouveau vecteur $y' = y + w - (m + \frac{y \cdot y}{2})x$. Calculons le produit scalaire $x \cdot y'$ :
    \[
    x \cdot y' = x \cdot y + x \cdot w - \left(m + \frac{y \cdot y}{2}\right)(x \cdot x) = 1 + m - 0 = 1 + m.
    \]
    Calculons maintenant la norme de $y'$ modulo $2$. Puisque $x \cdot x = 0$ et $y \cdot y \equiv 0 \pmod 2$, le terme en $x$ ne contribue pas à la parité de la norme. On a donc :
    \[
    y' \cdot y' \equiv y \cdot y + w \cdot w + 2(y \cdot w) \pmod 2.
    \]
    Comme $y \cdot y$ est pair et $2(y \cdot w)$ est pair, il reste $y' \cdot y' \equiv w \cdot w \pmod 2$. Or $w \cdot w$ est impair, donc $y' \cdot y'$ est un entier impair. Nous sommes ainsi ramenés au cas précédent : en remplaçant le couple $(x,y)$ par un couple modifié basé sur $(x, y')$, on sait construire un vecteur $z \in E$ tel que $z \cdot z = 1$ (ou $-1$ si l'on avait inversé le signe global de la forme).
\end{itemize}
...
% ============================================================
% PLACE POUR LA PREUVE DU CAS TYPE I (Tricky ou simple vérification des invariants)
% ============================================================
% \begin{proof}
% Il suffit de vérifier que la forme stable $sI_+ \oplus tI_-$ est bien indéfinie, de type I, et possède un rang et un indice identiques à ceux de $E$. Le Théorème \ref{thm:class_indef} conclut immédiatement à l'isomorphisme.
% \end{proof}
% ============================================================
...
% ============================================================
% PLACE POUR LA PREUVE DU CAS TYPE II (VERSION UNIFIÉE)
% ============================================================
% \begin{proof}
% Un calcul direct montre que le membre de droite est une forme indéfinie (car $p \geq 1$ dès lors que la forme est indéfinie) et de type II (comme somme directe de formes de type II). 
% Son rang vaut $2p + 8q = (r(E) - |\tau(E)|) + |\tau(E)| = r(E)$. 
% Son indice vaut $\text{sgn}(\tau(E)) \cdot 8q = \tau(E)$.
% L'unicité découlant du Théorème \ref{thm:class_indef} permet d'en déduire immédiatement l'isomorphisme.
% \end{proof}
% ============================================================
