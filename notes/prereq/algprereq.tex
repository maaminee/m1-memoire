...
Soit $M$ un $\mathbb{Z}$-module libre de rang fini. Une forme bilinéaire symétrique $Q : M \times M \to \mathbb{Z}$ est dite \textbf{unimodulaire} si la matrice $(Q(e_i, e_j))_{1 \le i, j \le n}$ représentant $Q$ dans une base $(e_i)_{1 \le i \le n}$ de $M$ est inversible sur $\mathbb{Z}$, c'est-à-dire si son déterminant vaut $\pm 1$.
\end{definition}
