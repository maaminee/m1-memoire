...
On notera que le théorème de Rokhlin fournit une obstruction antérieure mais partielle~: comme
$\sigma(E_8) = 8 \not\equiv 0 \pmod{16}$, toute $4$-variété lisse \emph{spin} de forme
d'intersection $Q_{E_8}$ est exclue. Le théorème de Donaldson lève l'hypothèse spin et donne
une obstruction valable sans restriction.

\medskip

On résume les propriétés de $E_8$ et les obstructions qu'elles engendrent~:

\begin{center}
  \renewcommand{\arraystretch}{1.4}
  \begin{tabular}{lcc}
    \hline
    Propriété de $Q_{E_8}$ & Valeur & Conséquence \\
    \hline
    Rang                            & $8$  & --- \\
    Signature $\sigma$              & $8$  & $8 \not\equiv 0 \pmod{16}$~: Rokhlin (cas spin) \\
    Unimodulaire                    & oui  & nécessaire pour bord vide \\
    Paire                           & oui  & exclut $\langle 1\rangle^{\oplus 8}$ par parité \\
    Définie positive                & oui  & Donaldson $\Rightarrow$ diagonalisable ou non lisse \\
    Diagonalisable sur $\mathbb{Z}$ & non  & incompatible avec Donaldson \\
    \hline
  \end{tabular}
\end{center}

\begin{remark}
  Ce phénomène est propre à la dimension $4$. En dimension $\geq 5$, un théorème dû à Smale garantit que toute variété topologique simplement connexe admet une
  structure lisse. En dimension $\leq 3$, le théorème de Moise assure que les catégories
  topologique et lisse coïncident. La dimension $4$ est précisément celle où la forme
  d'intersection est un invariant complet dans la catégorie topologique (Freedman) mais impose
  des contraintes drastiques dans la catégorie lisse (Donaldson), et $E_8$ est le témoin
  algébrique le plus économique de cet écart.
\end{remark}